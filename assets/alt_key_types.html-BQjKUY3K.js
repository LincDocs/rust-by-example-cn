...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div>`,9)]))}const i=s(t,[["render",o]]),d=JSON.parse('{"path":"/std/hash/alt_key_types.html","title":"更改或自定义关键字类型","lang":"zh-CN","frontmatter":{"description":"更改或自定义关键字类型 任何实现了 Eq 和 Hash trait 的类型都可以充当 HashMap 的键。这包括： bool （当然这个用处不大，因为只有两个可能的键） int，unit，以及其他整数类型 String 和 &str（友情提示：如果使用 String 作为键来创建 HashMap，则可以 将 &str 作为散列表的 .get() 方法...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"更改或自定义关键字类型\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/std/hash/alt_key_types.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"更改或自定义关键字类型"}],["meta",{"property":"og:description","content":"更改或自定义关键字类型 任何实现了 Eq 和 Hash trait 的类型都可以充当 HashMap 的键。这包括： bool （当然这个用处不大，因为只有两个可能的键） int，unit，以及其他整数类型 String 和 &str（友情提示：如果使用 String 作为键来创建 HashMap，则可以 将 &str 作为散列表的 .get() 方法..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":1.5,"words":449},"filePathRelative":"std/hash/alt_key_types.md","excerpt":"\\n<p>任何实现了 <code>Eq</code> 和 <code>Hash</code> trait 的类型都可以充当 <code>HashMap</code> 的键。这包括：</p>\\n<ul>\\n<li><code>bool</code> （当然这个用处不大，因为只有两个可能的键）</li>\\n<li><code>int</code>，<code>unit</code>，以及其他整数类型</li>\\n<li><code>String</code> 和 <code>&amp;str</code>（友情提示：如果使用 <code>String</code> 作为键来创建 <code>HashMap</code>，则可以<br>\\n将 <code>&amp;str</code> 作为散列表的 <code>.get()</code> 方法的参数，以获取值）</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"std/hash/alt_key_types.md","value":{"title":"alt_key_types","path":"std/hash/alt_key_types.md","outlink":[],"backlink":["SUMMARY.md"]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"SUMMARY.md","target":"std/hash/alt_key_types.md"}]}}}');export{i as comp,d as data};
