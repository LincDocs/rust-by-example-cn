import{_ as t,c as l,a,f as o,d as s,b as p,w as i,r as c,o as m}from"./app-w3dN5Ldv.js";const r={};function d(u,n){const e=c("RouteLink");return m(),l("div",null,[n[4]||(n[4]=a("h1",{id:"函数",tabindex:"-1"},"函数",-1)),a("p",null,[n[1]||(n[1]=s("排除")),p(e,{to:"/scope/lifetime/elision.html"},{default:i(()=>n[0]||(n[0]=[s("省略")])),_:1,__:[0]}),n[2]||(n[2]=s("（elision）的情况，带上生命周期的函数签名有一些限制："))]),n[5]||(n[5]=o(`<ul><li>任何引用<strong>都必须</strong>拥有标注好的生命周期。</li><li>任何被返回的引用<strong>都必须</strong>有和某个输入量相同的生命周期或是静态类型（<code>static</code>）。</li></ul><p>另外要注意，如果没有输入的函数返回引用，有时会导致返回的引用指向无效数据，这种情况下禁止它返回这样的引用。下面例子展示了一些合法的带有生命周期的函数：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>// 一个拥有生命周期 \`&#39;a\` 的输入引用，其中 \`&#39;a\` 的存活时间</span></span>
