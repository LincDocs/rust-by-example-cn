import{_ as i,c as p,f as l,a as r,b as e,d as t,w as a,r as c,o}from"./app-w3dN5Ldv.js";const u={};function d(m,s){const n=c("RouteLink");return o(),p("div",null,[s[3]||(s[3]=l(`<h1 id="结构体" tabindex="-1">结构体</h1><p>结构体（structure，缩写成 struct）有 3 种类型，使用 <code>struct</code> 关键字来创建：</p><ul><li>元组结构体（tuple struct），事实上就是具名元组而已。</li><li>经典的 <a href="https://en.wikipedia.org/wiki/Struct_(C_programming_language)" target="_blank" rel="noopener noreferrer">C 语言风格结构体</a>（C struct）。</li><li>单元结构体（unit struct），不带字段，在泛型中很有用。</li></ul><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>#[derive(Debug)]</span></span>
