import{_ as n,c as i,f as e,a as p,b as t,w as l,r,o,d as h}from"./app-w3dN5Ldv.js";const c={};function d(k,s){const a=r("RouteLink");return o(),i("div",null,[s[1]||(s[1]=e(`<h1 id="raii" tabindex="-1">RAII</h1><p>Rust 的变量不只是在栈中保存数据：它们也<strong>占有</strong>资源，比如 <code>Box&lt;T&gt;</code> 占有堆（heap）中的内存。Rust 强制实行 <a href="https://en.wikipedia.org/wiki/Resource_Acquisition_Is_Initialization" target="_blank" rel="noopener noreferrer">RAII</a>（Resource Acquisition Is Initialization，资源获取即初始化），所以任何对象在离开作用域时，它的析构函数（destructor）就被调用，然后它占有的资源就被释放。</p><p>这种行为避免了<strong>资源泄漏</strong>（resource leak），所以你再也不用手动释放内存或者担心内存泄漏（memory leak）！下面是个快速入门示例：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>// raii.rs</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>当然我们可以使用 <a href="https://valgrind.org/info/" target="_blank" rel="noopener noreferrer"><code>valgrind</code></a> 对内存错误进行仔细检查：</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> rustc</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> raii.rs</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;"> &amp;&amp; </span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">valgrind</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> ./raii</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="参见" tabindex="-1">参见：</h3>`,12)),p("p",null,[t(a,{to:"/std/box.html"},{default:l(()=>s[0]||(s[0]=[h("Box")])),_:1,__:[0]})])])}const u=n(c,[["render",d]]),b=JSON.parse('{"path":"/scope/raii.html","title":"RAII","lang":"zh-CN","frontmatter":{"description":"RAII Rust 的变量不只是在栈中保存数据：它们也占有资源，比如 Box<T> 占有堆（heap）中的内存。Rust 强制实行 RAII（Resource Acquisition Is Initialization，资源获取即初始化），所以任何对象在离开作用域时，它的析构函数（destructor）就被调用，然后它占有的资源就被释放。 这种行为避免...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"RAII\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/scope/raii.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"RAII"}],["meta",{"property":"og:description","content":"RAII Rust 的变量不只是在栈中保存数据：它们也占有资源，比如 Box<T> 占有堆（heap）中的内存。Rust 强制实行 RAII（Resource Acquisition Is Initialization，资源获取即初始化），所以任何对象在离开作用域时，它的析构函数（destructor）就被调用，然后它占有的资源就被释放。 这种行为避免..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":1.87,"words":561},"filePathRelative":"scope/raii.md","excerpt":"\\n<p>Rust 的变量不只是在栈中保存数据：它们也<strong>占有</strong>资源，比如 <code>Box&lt;T&gt;</code> 占有堆（heap）中的内存。Rust 强制实行 <a href=\\"https://en.wikipedia.org/wiki/Resource_Acquisition_Is_Initialization\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">RAII</a>（Resource Acquisition Is Initialization，资源获取即初始化），所以任何对象在离开作用域时，它的析构函数（destructor）就被调用，然后它占有的资源就被释放。</p>","autoDesc":true,"bioChainData":{"outlink":[{"title":"box","link":"std/box.html"}],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"scope/raii.md","value":{"title":"raii","path":"scope/raii.md","outlink":["std/box.md"],"backlink":["SUMMARY.md"]}},{"id":"std/box.md","value":{"title":"box","path":"std/box.md","outlink":[],"backlink":[]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"scope/raii.md","target":"std/box.md"},{"source":"SUMMARY.md","target":"scope/raii.md"}]}}}');export{u as comp,b as data};
