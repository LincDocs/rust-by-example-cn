import{_ as s,c as n,f as e,o as t}from"./app-w3dN5Ldv.js";const p={};function o(i,a){return t(),n("div",null,a[0]||(a[0]=[e(`<h1 id="运算符重载" tabindex="-1">运算符重载</h1><p>在 Rust 中，很多运算符可以通过 trait 来重载。也就是说，这些运算符可以根据它们的输入参数来完成不同的任务。这之所以可行，是因为运算符就是方法调用的语法糖。例如，<code>a + b</code> 中的 <code>+</code> 运算符会调用 <code>add</code> 方法（也就是 <code>a.add(b)</code>）。这个 <code>add</code> 方法是 <code>Add</code> trait 的一部分。因此，<code>+</code> 运算符可以被任何 <code>Add</code> trait 的实现者使用。</p><p>会重载运算符的 <code>trait</code>（比如 <code>Add</code> 这种）可以在<a href="https://rustwiki.org/zh-CN/core/ops/" target="_blank" rel="noopener noreferrer">这里</a>查看。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>use std::ops;</span></span>
