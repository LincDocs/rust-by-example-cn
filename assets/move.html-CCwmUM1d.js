import{_ as t,c as p,a,f as l,d as s,b as o,w as i,r,o as c}from"./app-w3dN5Ldv.js";const d={};function u(m,n){const e=r("RouteLink");return c(),p("div",null,[n[5]||(n[5]=a("h1",{id:"所有权和移动",tabindex:"-1"},"所有权和移动",-1)),a("p",null,[n[1]||(n[1]=s("因为变量要负责释放它们拥有的资源，所以")),n[2]||(n[2]=a("strong",null,"资源只能拥有一个所有者",-1)),n[3]||(n[3]=s("。这也防止了资源的重复释放。注意并非所有变量都拥有资源（例如")),o(e,{to:"/flow_control/match/destructuring/destructure_pointers.html"},{default:i(()=>n[0]||(n[0]=[s("引用")])),_:1,__:[0]}),n[4]||(n[4]=s("）。"))]),n[6]||(n[6]=l(`<p>在进行赋值（<code>let x = y</code>）或通过值来传递函数参数（<code>foo(x)</code>）的时候，资源的<strong>所有权</strong>（ownership）会发生转移。按照 Rust 的说法，这被称为资源的<strong>移动</strong>（move）。</p><p>在移动资源之后，原来的所有者不能再被使用，这可避免悬挂指针（dangling pointer）的产生。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>// 此函数取得堆分配的内存的所有权</span></span>
