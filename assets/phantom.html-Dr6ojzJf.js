import{_ as r,c as o,a,f as m,d as s,b as t,w as e,r as l,o as c}from"./app-w3dN5Ldv.js";const u={},d={href:"https://rustwiki.org/zh-CN/std/marker/struct.PhantomData.html",target:"_blank",rel:"noopener noreferrer"};function h(g,n){const i=l("VPIcon"),p=l("RouteLink");return c(),o("div",null,[n[9]||(n[9]=a("h1",{id:"虚类型参数",tabindex:"-1"},"虚类型参数",-1)),n[10]||(n[10]=a("p",null,"虚类型（phantom type）参数是一种在运行时不出现，而在（且仅在）编译时进行静态检查的类型参数。",-1)),n[11]||(n[11]=a("p",null,"可以用额外的泛型类型参数指定数据类型，该类型可以充当标记，也可以供编译时类型检查使用。这些额外的参数没有存储值，也没有运行时行为。",-1)),a("p",null,[n[2]||(n[2]=s("在下面例子中，我们使用 ")),a("a",d,[n[0]||(n[0]=s("std")),t(i,{icon:"marker"}),n[1]||(n[1]=s("PhantomData"))]),n[3]||(n[3]=s(" 作为虚类型参数的类型，创建包含不同数据类型的元组。"))]),n[12]||(n[12]=m(`<div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>use std::marker::PhantomData;</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h3 id="参见" tabindex="-1">参见：</h3>`,2)),a("p",null,[t(p,{to:"/trait/derive.html"},{default:e(()=>n[4]||(n[4]=[s("Derive")])),_:1,__:[4]}),n[7]||(n[7]=s(", ")),t(p,{to:"/custom_types/structs.html"},{default:e(()=>n[5]||(n[5]=[s("结构体")])),_:1,__:[5]}),n[8]||(n[8]=s(", 和 ")),t(p,{to:"/custom_types/structs.html"},{default:e(()=>n[6]||(n[6]=[s("元组结构体")])),_:1,__:[6]})])])}const f=r(u,[["render",h]]),y=JSON.parse('{"path":"/generics/phantom.html","title":"虚类型参数","lang":"zh-CN","frontmatter":{"description":"虚类型参数 虚类型（phantom type）参数是一种在运行时不出现，而在（且仅在）编译时进行静态检查的类型参数。 可以用额外的泛型类型参数指定数据类型，该类型可以充当标记，也可以供编译时类型检查使用。这些额外的参数没有存储值，也没有运行时行为。 在下面例子中，我们使用 std 作为虚类型参数的类型，创建包含不同数据类型的元组。 参见： , , 和","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"虚类型参数\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/generics/phantom.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"虚类型参数"}],["meta",{"property":"og:description","content":"虚类型参数 虚类型（phantom type）参数是一种在运行时不出现，而在（且仅在）编译时进行静态检查的类型参数。 可以用额外的泛型类型参数指定数据类型，该类型可以充当标记，也可以供编译时类型检查使用。这些额外的参数没有存储值，也没有运行时行为。 在下面例子中，我们使用 std 作为虚类型参数的类型，创建包含不同数据类型的元组。 参见： , , 和"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":1.47,"words":441},"filePathRelative":"generics/phantom.md","excerpt":"\\n<p>虚类型（phantom type）参数是一种在运行时不出现，而在（且仅在）编译时进行静态检查的类型参数。</p>\\n<p>可以用额外的泛型类型参数指定数据类型，该类型可以充当标记，也可以供编译时类型检查使用。这些额外的参数没有存储值，也没有运行时行为。</p>\\n<p>在下面例子中，我们使用 <a href=\\"https://rustwiki.org/zh-CN/std/marker/struct.PhantomData.html\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">std</a> 作为虚类型参数的类型，创建包含不同数据类型的元组。</p>","autoDesc":true,"bioChainData":{"outlink":[{"title":"derive","link":"trait/derive.html"},{"title":"structs","link":"custom_types/structs.html"}],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"generics/phantom.md","value":{"title":"phantom","path":"generics/phantom.md","outlink":["trait/derive.md","custom_types/structs.md"],"backlink":["SUMMARY.md"]}},{"id":"trait/derive.md","value":{"title":"derive","path":"trait/derive.md","outlink":[],"backlink":[]}},{"id":"custom_types/structs.md","value":{"title":"structs","path":"custom_types/structs.md","outlink":[],"backlink":[]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"generics/phantom.md","target":"trait/derive.md"},{"source":"generics/phantom.md","target":"custom_types/structs.md"},{"source":"SUMMARY.md","target":"generics/phantom.md"}]}}}');export{f as comp,y as data};
