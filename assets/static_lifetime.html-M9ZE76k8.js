import{_ as n,c as e,f as i,a as t,b as c,w as p,r as l,o,d as m}from"./app-w3dN5Ldv.js";const r={};function d(u,s){const a=l("RouteLink");return o(),e("div",null,[s[1]||(s[1]=i(`<h1 id="static" tabindex="-1">static</h1><p><code>&#39;static</code> 生命周期是可能的生命周期中最长的，它会在整个程序运行的时期中存在。<code>&#39;static</code> 生命周期也可被强制转换成一个更短的生命周期。有两种方式使变量拥有 <code>&#39;static</code> 生命周期，它们都把数据保存在可执行文件的只读内存区：</p><ul><li>使用 <code>static</code> 声明来产生常量（constant）。</li><li>产生一个拥有 <code>&amp;&#39;static str</code> 类型的 <code>string</code> 字面量。</li></ul><p>看下面的例子，了解列举到的各个方法：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>// 产生一个拥有 \`&#39;static\` 生命周期的常量。</span></span>
