import{_ as a,c as s,f as p,o as e}from"./app-w3dN5Ldv.js";const t={};function o(i,n){return e(),s("div",null,n[0]||(n[0]=[p(`<h1 id="drop" tabindex="-1">Drop</h1><p><a href="https://rustwiki.org/zh-CN/std/ops/trait.Drop.html" target="_blank" rel="noopener noreferrer"><code>Drop</code></a> trait 只有一个方法：<code>drop</code>，当对象离开作用域时会自动调用该方法。<code>Drop</code> trait 的主要作用是释放实现者的实例拥有的资源。</p><p><code>Box</code>，<code>Vec</code>，<code>String</code>，<code>File</code>，以及 <code>Process</code> 是一些实现了 <code>Drop</code> trait 来释放资源的类型。<code>Drop</code> trait 也可以为任何自定义数据类型手动实现。</p><p>下面示例给 <code>drop</code> 函数增加了打印到控制台的功能，用于宣布它在什么时候被调用。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>struct Droppable {</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div>`,5)]))}const l=a(t,[["render",o]]),c=JSON.parse('{"path":"/trait/drop.html","title":"Drop","lang":"zh-CN","frontmatter":{"description":"Drop Drop trait 只有一个方法：drop，当对象离开作用域时会自动调用该方法。Drop trait 的主要作用是释放实现者的实例拥有的资源。 Box，Vec，String，File，以及 Process 是一些实现了 Drop trait 来释放资源的类型。Drop trait 也可以为任何自定义数据类型手动实现。 下面示例给 drop ...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Drop\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/trait/drop.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"Drop"}],["meta",{"property":"og:description","content":"Drop Drop trait 只有一个方法：drop，当对象离开作用域时会自动调用该方法。Drop trait 的主要作用是释放实现者的实例拥有的资源。 Box，Vec，String，File，以及 Process 是一些实现了 Drop trait 来释放资源的类型。Drop trait 也可以为任何自定义数据类型手动实现。 下面示例给 drop ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":0.9,"words":271},"filePathRelative":"trait/drop.md","excerpt":"\\n<p><a href=\\"https://rustwiki.org/zh-CN/std/ops/trait.Drop.html\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\"><code>Drop</code></a> trait 只有一个方法：<code>drop</code>，当对象离开作用域时会自动调用该方法。<code>Drop</code> trait 的主要作用是释放实现者的实例拥有的资源。</p>\\n<p><code>Box</code>，<code>Vec</code>，<code>String</code>，<code>File</code>，以及 <code>Process</code> 是一些实现了 <code>Drop</code> trait 来释放资源的类型。<code>Drop</code> trait 也可以为任何自定义数据类型手动实现。</p>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"trait/drop.md","value":{"title":"drop","path":"trait/drop.md","outlink":[],"backlink":["SUMMARY.md"]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"SUMMARY.md","target":"trait/drop.md"}]}}}');export{l as comp,c as data};
