import{_ as s,e as n,k as e,o as i}from"./app-D5VbsUty.js";const p={};function l(t,a){return i(),n("div",null,a[0]||(a[0]=[e(`<h1 id="散列表-hashmap" tabindex="-1"><a class="header-anchor" href="#散列表-hashmap"><span>散列表 HashMap</span></a></h1><p>vector 通过整型下标来存储值，而 <code>HashMap</code>（散列表）通过键（key）来存储值。<code>HashMap</code> 的键可以是布尔型、整型、字符串，或任意实现了 <code>Eq</code> 和 <code>Hash</code> trait 的其他类型。在下一节将进一步介绍。</p><p>和 vector 类似，<code>HashMap</code> 也是可增长的，但 HashMap 在占据了多余空间时还可以缩小自己。可以使用 <code>HashMap::with_capacity(unit)</code> 创建具有一定初始容量的 HashMap，也可以使用 <code>HashMap::new()</code> 来获得一个带有默认初始容量的 HashMap（这是推荐方式）。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" data-title="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>use std::collections::HashMap;</span></span>
