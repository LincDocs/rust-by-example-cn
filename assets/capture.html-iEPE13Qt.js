import{_ as p,c as l,f as e,a as s,b as i,d as t,w as c,r as o,o as r}from"./app-w3dN5Ldv.js";const u={};function m(d,n){const a=o("RouteLink");return r(),l("div",null,[n[3]||(n[3]=e(`<h1 id="捕获" tabindex="-1">捕获</h1><p>闭包本质上很灵活，能做功能要求的事情，使闭包在没有类型标注的情况下运行。这使得捕获（capture）能够灵活地适应用例，既可移动（move），又可借用（borrow）。闭包可以通过以下方式捕获变量：</p><ul><li>通过引用：<code>&amp;T</code></li><li>通过可变引用：<code>&amp;mut T</code></li><li>通过值：<code>T</code></li></ul><p>闭包优先通过引用来捕获变量，并且仅在需要时使用其他方式。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>fn main() {</span></span>
...
<span class="line"><span>    //consume();</span></span>
<span class="line"><span>    // ^ 试一试：将此行注释去掉。</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>在竖线 <code>|</code> 之前使用 <code>move</code> 会强制闭包取得被捕获变量的所有权：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>fn main() {</span></span>
