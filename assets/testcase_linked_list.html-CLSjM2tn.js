import{_ as i,c as t,f as c,a,b as p,d as l,w as e,r as o,o as d}from"./app-w3dN5Ldv.js";const m={};function r(u,s){const n=o("RouteLink");return d(),t("div",null,[s[3]||(s[3]=c(`<h1 id="测试实例-链表" tabindex="-1">测试实例：链表</h1><p><code>enum</code> 的一个常见用法就是创建链表（linked-list）：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>use List::*;</span></span>
