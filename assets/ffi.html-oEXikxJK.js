import{_ as n,c as a,f as p,o as e}from"./app-w3dN5Ldv.js";const l={};function i(t,s){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="外部语言函数接口" tabindex="-1">外部语言函数接口</h1><p>Rust 提供了到 C 语言库的外部语言函数接口（Foreign Function Interface，FFI）。外部语言函数必须在一个 <code>extern</code> 代码块中声明，且该代码块要带有一个包含库名称的 <code>#[link]</code> 属性。</p><div class="language-rust,ignore line-numbers-mode" data-highlighter="shiki" data-ext="rust,ignore" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,ignore"><span class="line"><span>use std::fmt;</span></span>
