import{_ as t,c as r,f as p,a as s,d as e,b as i,w as l,r as o,o as c}from"./app-w3dN5Ldv.js";const u={};function d(m,n){const a=o("RouteLink");return c(),r("div",null,[n[3]||(n[3]=p(`<h1 id="引入" tabindex="-1">引入 <code>?</code></h1><p>有时我们只是想 <code>unwrap</code> 且避免产生 <code>panic</code>。到现在为止，对 <code>unwrap</code> 的错误处理都在强迫我们一层层地嵌套，然而我们只是想把里面的变量拿出来。<code>?</code> 正是为这种情况准备的。</p><p>当找到一个 <code>Err</code> 时，可以采取两种行动：</p><ol><li><code>panic!</code>，不过我们已经决定要尽可能避免 panic 了。</li><li>返回它，因为 <code>Err</code> 就意味着它已经不能被处理了。</li></ol><p><code>?</code> <strong>几乎</strong>[^†] 就等于一个会返回 <code>Err</code> 而不是 <code>panic</code> 的 <code>unwrap</code>。我们来看看怎样简化之前使用组合算子的例子：</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>use std::num::ParseIntError;</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="try-宏" tabindex="-1"><code>try!</code> 宏</h2><p>在 <code>?</code> 出现以前，相同的功能是使用 <code>try!</code> 宏完成的。现在我们推荐使用 <code>?</code> 运算符，但是在老代码中仍然会看到 <code>try!</code>。如果使用 <code>try!</code> 的话，上一个例子中的 <code>multiply</code> 函数看起来会像是这样：</p><div class="language-rust,editable,edition2015 line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable,edition2015" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable,edition2015"><span class="line"><span>use std::num::ParseIntError;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>fn multiply(first_number_str: &amp;str, second_number_str: &amp;str) -&gt; Result&lt;i32, ParseIntError&gt; {</span></span>
