import{_ as s,c as a,f as p,o as l}from"./app-w3dN5Ldv.js";const i={};function e(c,n){return l(),a("div",null,n[0]||(n[0]=[p(`<h1 id="可见性" tabindex="-1">可见性</h1><p>默认情况下，模块中的项拥有私有的可见性（private visibility），不过可以加上 <code>pub</code> 修饰语来重载这一行为。模块中只有公有的（public）项可以从模块外的作用域访问。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>// 一个名为 \`my_mod\` 的模块</span></span>
