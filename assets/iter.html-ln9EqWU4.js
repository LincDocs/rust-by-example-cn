import{_ as a,c as s,f as t,o as e}from"./app-w3dN5Ldv.js";const p={};function i(l,n){return e(),s("div",null,n[0]||(n[0]=[t(`<h1 id="iterator" tabindex="-1">Iterator</h1><p><code>Iterator</code> trait 用来对集合（collection）类型（比如数组）实现迭代器。</p><p>这个 trait 只需定义一个返回 <code>next</code>（下一个）元素的方法，这可手动在 <code>impl</code> 代码块中定义，或者自动定义（比如在数组或区间中）。</p><p>为方便起见，<code>for</code> 结构会使用 <a href="https://rustwiki.org/zh-CN/std/iter/trait.IntoIterator.html" target="_blank" rel="noopener noreferrer"><code>.into_iter()</code></a> 方法将一些集合类型转换为迭代器。</p><p>下面例子展示了如何使用 <code>Iterator</code> trait 的方法，更多可用的方法可以看<a href="https://rustwiki.org/zh-CN/core/iter/trait.Iterator.html" target="_blank" rel="noopener noreferrer">这里</a>。</p><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>struct Fibonacci {</span></span>
