import{_ as s,c as a,f as e,o as p}from"./app-w3dN5Ldv.js";const l={};function t(r,n){return p(),a("div",null,n[0]||(n[0]=[e(`<h1 id="定义一个错误类型" tabindex="-1">定义一个错误类型</h1><p>有时候把所有不同的错误都视为一种错误类型会简化代码。我们将用一个自定义错误类型来演示这一点。</p><p>Rust 允许我们定义自己的错误类型。一般来说，一个 “好的” 错误类型应当：</p><ul><li>用同一个类型代表了多种错误</li><li>向用户提供了清楚的错误信息</li><li>能够容易地与其他类型比较 <ul><li>好的例子：<code>Err(EmptyVec)</code></li><li>坏的例子：<code>Err(&quot;Please use a vector with at least one element&quot;.to_owned())</code></li></ul></li><li>能够容纳错误的具体信息 <ul><li>好的例子：<code>Err(BadChar(c, position))</code></li><li>坏的例子：<code>Err(&quot;+ cannot be used here&quot;.to_owned())</code></li></ul></li><li>能够与其他错误很好地整合</li></ul><div class="language-rust,editable line-numbers-mode" data-highlighter="shiki" data-ext="rust,editable" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-rust,editable"><span class="line"><span>use std::error;</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div>`,5)]))}const o=s(l,[["render",t]]),c=JSON.parse('{"path":"/error/multiple_error_types/define_error_type.html","title":"定义一个错误类型","lang":"zh-CN","frontmatter":{"description":"定义一个错误类型 有时候把所有不同的错误都视为一种错误类型会简化代码。我们将用一个自定义错误类型来演示这一点。 Rust 允许我们定义自己的错误类型。一般来说，一个 “好的” 错误类型应当： 用同一个类型代表了多种错误 向用户提供了清楚的错误信息 能够容易地与其他类型比较 好的例子：Err(EmptyVec) 坏的例子：Err(\\"Please use ...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"定义一个错误类型\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/error/multiple_error_types/define_error_type.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"定义一个错误类型"}],["meta",{"property":"og:description","content":"定义一个错误类型 有时候把所有不同的错误都视为一种错误类型会简化代码。我们将用一个自定义错误类型来演示这一点。 Rust 允许我们定义自己的错误类型。一般来说，一个 “好的” 错误类型应当： 用同一个类型代表了多种错误 向用户提供了清楚的错误信息 能够容易地与其他类型比较 好的例子：Err(EmptyVec) 坏的例子：Err(\\"Please use ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":1.76,"words":528},"filePathRelative":"error/multiple_error_types/define_error_type.md","excerpt":"\\n<p>有时候把所有不同的错误都视为一种错误类型会简化代码。我们将用一个自定义错误类型来演示这一点。</p>\\n<p>Rust 允许我们定义自己的错误类型。一般来说，一个 “好的” 错误类型应当：</p>\\n<ul>\\n<li>用同一个类型代表了多种错误</li>\\n<li>向用户提供了清楚的错误信息</li>\\n<li>能够容易地与其他类型比较\\n<ul>\\n<li>好的例子：<code>Err(EmptyVec)</code></li>\\n<li>坏的例子：<code>Err(\\"Please use a vector with at least one element\\".to_owned())</code></li>\\n</ul>\\n</li>\\n<li>能够容纳错误的具体信息\\n<ul>\\n<li>好的例子：<code>Err(BadChar(c, position))</code></li>\\n<li>坏的例子：<code>Err(\\"+ cannot be used here\\".to_owned())</code></li>\\n</ul>\\n</li>\\n<li>能够与其他错误很好地整合</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"error/multiple_error_types/define_error_type.md","value":{"title":"define_error_type","path":"error/multiple_error_types/define_error_type.md","outlink":[],"backlink":["SUMMARY.md"]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"SUMMARY.md","target":"error/multiple_error_types/define_error_type.md"}]}}}');export{o as comp,c as data};
