...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>在 <a href="https://rustwiki.org/zh-CN/std/fmt/" target="_blank" rel="noopener noreferrer"><code>fmt::fmt</code></a> 文档中可以查看<a href="https://rustwiki.org/zh-CN/std/fmt/#formatting-traits" target="_blank" rel="noopener noreferrer">格式化 traits 一览表</a>和它们的参数类型。</p><h3 id="动手试一试" tabindex="-1">动手试一试</h3><p>为上面的 <code>Color</code> 结构体实现 <code>fmt::Display</code>，应得到如下的输出结果：</p><div class="language-text line-numbers-mode" data-highlighter="shiki" data-ext="text" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-text"><span class="line"><span>RGB (128, 255, 90) 0x80FF5A</span></span>
<span class="line"><span>RGB (0, 3, 254) 0x0003FE</span></span>
<span class="line"><span>RGB (0, 0, 0) 0x000000</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>如果感到疑惑，可看下面两条提示：</p><ul><li>你<a href="https://rustwiki.org/zh-CN/std/fmt/#argument-types" target="_blank" rel="noopener noreferrer">可能需要多次列出每个颜色</a>，</li><li>你可以使用 <code>:02</code> <a href="https://rustwiki.org/zh-CN/std/fmt/#width" target="_blank" rel="noopener noreferrer">补零使位数为 2 位</a>。</li></ul><h3 id="参见" tabindex="-1">参见：</h3><p><a href="https://rustwiki.org/zh-CN/std/fmt/" target="_blank" rel="noopener noreferrer"><code>std::fmt</code></a></p>`,14)]))}const r=s(p,[["render",l]]),c=JSON.parse('{"path":"/hello/print/fmt.html","title":"格式化","lang":"zh-CN","frontmatter":{"description":"格式化 我们已经看到，格式化的方式是通过格式字符串来指定的： format!(\\"{}\\", foo) -> \\"3735928559\\" format!(\\"0x{:X}\\", foo) -> \\"0xDEADBEEF\\" format!(\\"0o{:o}\\", foo) -> \\"0o33653337357\\" 根据使用的参数类型是 X、o 还是未指定，同样的变量（foo...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"格式化\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincDocs.github.io/rust-by-example-cn/hello/print/fmt.html"}],["meta",{"property":"og:site_name","content":"rust-by-example-cn"}],["meta",{"property":"og:title","content":"格式化"}],["meta",{"property":"og:description","content":"格式化 我们已经看到，格式化的方式是通过格式字符串来指定的： format!(\\"{}\\", foo) -> \\"3735928559\\" format!(\\"0x{:X}\\", foo) -> \\"0xDEADBEEF\\" format!(\\"0o{:o}\\", foo) -> \\"0o33653337357\\" 根据使用的参数类型是 X、o 还是未指定，同样的变量（foo..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":1.6,"words":481},"filePathRelative":"hello/print/fmt.md","excerpt":"\\n<p>我们已经看到，格式化的方式是通过<strong>格式字符串</strong>来指定的：</p>\\n<ul>\\n<li><code>format!(\\"{}\\", foo)</code> -&gt; <code>\\"3735928559\\"</code></li>\\n<li><code>format!(\\"0x{:X}\\", foo)</code> -&gt;<br>\\n<a href=\\"https://en.wikipedia.org/wiki/Deadbeef#Magic_debug_values\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\"><code>\\"0xDEADBEEF\\"</code></a></li>\\n<li><code>format!(\\"0o{:o}\\", foo)</code> -&gt; <code>\\"0o33653337357\\"</code></li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[{"title":"SUMMARY","link":"SUMMARY.html"}],"localMap":{"nodes":[{"id":"hello/print/fmt.md","value":{"title":"fmt","path":"hello/print/fmt.md","outlink":[],"backlink":["SUMMARY.md"]}},{"id":"SUMMARY.md","value":{"title":"SUMMARY","path":"SUMMARY.md","outlink":[],"backlink":[]}}],"links":[{"source":"SUMMARY.md","target":"hello/print/fmt.md"}]}}}');export{r as comp,c as data};
